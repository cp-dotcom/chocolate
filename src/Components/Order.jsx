...
//             <div
//               key={order.id}
//               className="bg-white shadow rounded-xl p-6 border border-[#f3e8e3]"
//             >
...
//                       <h4 className="font-semibold text-[#6f4e37]">{item.name}</h4>
//                       <p className="text-sm text-gray-600">
//                         ₹{item.price} × {item.qty}
//                       </p>
//                     </div>
            ...
            >
              ...
              <div className="border-t pt-4">
                <div className="flex justify-between items-center">
                  <div>
                    <p className="text-sm text-gray-600">Payment: {order.payment.toUpperCase()}</p>
                    <p className="text-sm text-gray-600">Shipping to: {order.address.substring(0, 30)}...</p>
                  </div>
                  <span className="text-lg font-bold text-[#6f4e37]">
